...
const products = [
  { id: 1, name: "BUSINESS CARDS", desc: "Professional business cards", img: "/products/21.png" },
  { id: 2, name: "STAMPS", desc: "Custom stamps for office use", img: "/products/29.png" },
  { id: 3, name: "LETTER HEAD", desc: "Custom letterheads for official use", img: "/products/22.png" },
  { id: 4, name: "BROCHURES", desc: "Informative brochures for marketing", img: "/products/27.png" },
  { id: 5, name: "BILL BOOKS", desc: "Bill books for receipts", img: "/products/53.png" },
  { id: 6, name: "COMPANY PROFILE", desc: "Printed company profiles", img: "/products/33.png" },
  { id: 7, name: "FILE COVER", desc: "File covers for organization", img: "/products/23.png" },
  { id: 8, name: "ENVELOPES", desc: "Custom envelopes for mailing", img: "/products/24.png" },
  { id: 9, name: "PVC CARDS", desc: "PVC cards for ID and membership", img: "/products/51.png" },
  { id: 10, name: "STICKERS & LABELS", desc: "Custom stickers and labels for branding", img: "/products/26.png" },
  { id: 11, name: "PANAFLEX", desc: "Panaflex banners", img: "/products/60.png" },
  { id: 12, name: "CALENDARS", desc: "Custom calendars for promotion", img: "/products/31.png" },
  { id: 13, name: "DIARY", desc: "Custom diaries", img: "/products/43.png" },
  { id: 14, name: "SPIRAL NOTEPADS", desc: "Spiral bound notepads", img: "/products/54.png" },
  { id: 15, name: "PENS", desc: "Branded pens for promotion", img: "/products/40.png" },
  { id: 16, name: "KEYCHAINS", desc: "Custom keychains", img: "/products/41.png" },
  { id: 17, name: "MUGS", desc: "Personalized mugs", img: "/products/42.png" },
  { id: 18, name: "TEMPERATURE BOTTLE", desc: "Printed temperature bottles", img: "/products/45.png" },
  { id: 19, name: "COFFEE MUG", desc: "Custom coffee mugs", img: "/products/42.png" },
  { id: 20, name: "SCHOOL BADGES", desc: "Custom school badges", img: "/products/55.png" },
  { id: 21, name: "SHIELDS", desc: "Award shields for recognition", img: "/products/32.png" },
  { id: 22, name: "CUSTOMIZED BOX", desc: "Fully customized boxes", img: "/products/49.png" },
  { id: 23, name: "BURGER BOX", desc: "Custom burger boxes", img: "/products/48.png" },
  { id: 24, name: "BUTTER PAPER", desc: "Butter paper for wrapping", img: "/products/50.png" },
  { id: 25, name: "RESTAURANT PACKAGING", desc: "Packaging solutions for restaurants", img: "/products/30.png" },
  { id: 26, name: "PIZZA BOXES", desc: "Custom pizza boxes", img: "/products/44.png" },
  { id: 27, name: "TISSUE BOXES", desc: "Custom tissue boxes", img: "/products/39.png" },
  { id: 28, name: "TISSUE PRINTING", desc: "Custom tissue printing", img: "/products/39.png" },
  { id: 29, name: "SPORTS WEARS PRINTING", desc: "Custom sports wear printing", img: "/products/36.png" },
  { id: 30, name: "T-SHIRTS AND HOODIE", desc: "Custom printed t-shirts and hoodies", img: "/products/36.png" },
  { id: 31, name: "CLOTH TAGS", desc: "Woven cloth tags", img: "/products/28.png" },
  { id: 32, name: "PRICE TAGS", desc: "Custom price tags for retail", img: "/products/35.png" },
  { id: 33, name: "STANDUP POUCH", desc: "Standup pouches for packaging", img: "/products/17.png" },
  { id: 34, name: "HAND BAGS", desc: "Handle bags for easy carrying", img: "/products/9.png" },
]
